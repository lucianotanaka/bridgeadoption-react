...
export default function CiscoLCIPage() {
  ...
  const tabs: { key: TabType; label: string; icon: React.ReactNode }[] = [
    { key: "report", label: "Cisco LCI Report", icon: <FileText size={14} /> },
    { key: "forecast", label: "Forecast", icon: <TrendingUp size={14} /> },
    { key: "eligible", label: "Eligible Status", icon: <BarChart3 size={14} /> },
    { key: "solution", label: "Solution vs Project", icon: <Layers size={14} /> },
  ];
