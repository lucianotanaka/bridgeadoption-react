...
class AuthRepository:
    ...
    def load_user_permissions(self, user_id: int):
        ...
        try:
            ...
            for role_name, resource_name, resource_key, resource_icon, action_key, is_active in rows:

                # Nível Role
                if role_name not in permissions:
                    permissions[role_name] = {}

                # Define diretamente a action (não é mais lista)
                permissions[role_name][resource_name] = {
