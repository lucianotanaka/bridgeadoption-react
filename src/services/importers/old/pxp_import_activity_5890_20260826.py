...
def _process_single_row(
    ...
    try:
        ...
        if existing_activity is None:
            ...
            # Nova regra: activity encontrada via fallback (não pelo WS).
            # Se o WS da activity no banco for NULL ou igual ao WS da task pai,
            # E o CR Party ID bater com o valor do Excel → corrigir o WS.
            if existing_activity is not None and activity_ws:
                current_activity_ws = existing_activity.get("activity_ws")
                ...
                ws_needs_correction = (
                    current_activity_ws is None
                    or current_activity_ws == task_ws
                )
                cr_party_matches = (
