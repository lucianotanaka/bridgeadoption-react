    ...
    if activity_ws:
        try:
            ...
            if ids_by_ws:
                ...
                if activity_id:
                    data = repo_activity.get_columns_by_activity_id(
...
def _process_single_row(
    ...
    try:
        ...
        if existing_activity is None:
            ...
            existing_activity = repo_activity.get_columns_by_activity_id(
                activity_id=activity_id,
                columns=[
                    "activity_id",
                    "activity_task_id",
        ...
        refreshed_activity = repo_activity.get_columns_by_activity_id(
            activity_id=activity_id,
            columns=[
                "activity_id",
                "activity_task_id",
