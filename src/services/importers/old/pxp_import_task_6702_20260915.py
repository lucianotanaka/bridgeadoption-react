...
def _process_single_row(
    ...
    try:
        ...
        if opt_in_flag == OPT_IN_FLAG_OPTED_OUT:
            ...
            # Ignora somente se já estiver Cancelled (4) ou Declined (5).
            # Status 6 (Expired) e 10 (Completed) devem ser cancelados pelo Opted Out.
            if current_status in {TASK_STATUS_CANCELLED, TASK_STATUS_DECLINED}:
                if execution_log_path:
                    _append_execution_log(
                        execution_log_path,
